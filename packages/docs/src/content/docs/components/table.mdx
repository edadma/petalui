...
<Example title="Custom Selection" description="Selection with custom column title and hidden select-all." source={TableDemoSource} fn="CustomSelectionDemo">
  <CustomSelectionDemo client:load slot="demo" />
</Example>
...
<Example title="Title and Footer" description="Add title and footer sections to the table." source={TableDemoSource} fn="TitleFooterDemo">
  <TitleFooterDemo client:load slot="demo" />
</Example>

<Example title="Summary Row" description="Add a summary row (tfoot) for totals or aggregations." source={TableDemoSource} fn="SummaryDemo">
  <SummaryDemo client:load slot="demo" />
</Example>

<Example title="Row Class Name" description="Apply conditional styling to rows based on data." source={TableDemoSource} fn="RowClassNameDemo">
  <RowClassNameDemo client:load slot="demo" />
</Example>
