...
const App: React.FC = () => (
  <Rating defaultValue={4}>
    <Rating.Item value={1} mask="heart" color="bg-red-400" />
    <Rating.Item value={2} mask="heart" color="bg-red-400" />
    <Rating.Item value={3} mask="heart" color="bg-red-400" />
    <Rating.Item value={4} mask="heart" color="bg-red-400" />
    <Rating.Item value={5} mask="heart" color="bg-red-400" />
  </Rating>
)
...
const App: React.FC = () => (
  <Rating defaultValue={3}>
    <Rating.Item value={1} color="bg-red-400" />
    <Rating.Item value={2} color="bg-orange-400" />
    <Rating.Item value={3} color="bg-yellow-400" />
    <Rating.Item value={4} color="bg-lime-400" />
    <Rating.Item value={5} color="bg-green-400" />
  </Rating>
)
...
const App: React.FC = () => (
  <Rating defaultValue={3}>
    <Rating.Item value={1} mask="star-2" color="bg-green-500" />
    <Rating.Item value={2} mask="star-2" color="bg-green-500" />
    <Rating.Item value={3} mask="star-2" color="bg-green-500" />
    <Rating.Item value={4} mask="star-2" color="bg-green-500" />
    <Rating.Item value={5} mask="star-2" color="bg-green-500" />
  </Rating>
)
