...
const dFooterCenter = 'd-footer-center'
const dFooterHorizontal = 'd-footer-horizontal'
const dFooterVertical = 'd-footer-vertical'
const dFooterTitle = 'd-footer-title'
